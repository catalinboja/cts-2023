...
2. The use of an external library that contains Disney characters.
- currently the game contains its own characters that are part of the ACME framework

3. Changing the characteristics of some superheroes during the game / run-time
...
4. In order to allow other companies or players to develop external solutions that connect to the game, a library (an API) must be developed.
